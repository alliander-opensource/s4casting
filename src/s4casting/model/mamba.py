...
from s4casting.model._selective_scan_interface import selective_scan_fn, mamba_inner_fn

# this gives a small performance improvement, but one thing at a time
# try:
#    from causal_conv1d import causal_conv1d_fn, causal_conv1d_update
# except ImportError:
causal_conv1d_fn, causal_conv1d_update = None, None

# only need for per sample update-like inference
# try:
...
class Mamba(nn.Module):
    ...
    def forward(self, hidden_states, inference_params=None, *, rate=1.0):
        """
        hidden_states: (B, L, D)
